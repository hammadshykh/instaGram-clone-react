...
import { AiOutlineMenu, AiOutlinePlus, AiOutlineDown, AiOutlineLeft } from "react-icons/ai";
...
const InstaChats = () => {
    return (
        <Box bg='black' px='20px'>
            <Flex alignItems='center' justifyContent='space-between' display={['flex', 'none', 'none', 'none', 'none']} pt='10px' mx='15px'>
                <Flex justifyContent="start" w="110px" color='white' alignItems='center'>
            ...
            <Flex my='10px' textAlign='center'>
                <Box
                    ...
                    <Img
                        ...
                        border="2px solid"
                        borderColor="red" />
                    <Text fontSize='12' color='#fff'>Leave me a note</Text>
                </Box>
                <Box>
                <Img
                    cursor="pointer"
                    ...
                    border="2px solid"
                    borderColor="red" />
                    <Text fontSize='12' color='#fff'>Icc</Text>
                    </Box>
                <Box>
                <Img
                    cursor="pointer"
                    ...
                    borderColor="red" />
                    <Text fontSize='12' color='#fff'>User</Text>
                    </Box>
            </Flex>
            ...
            {localData.map((data) => (
                ...
                > <Flex alignItems="center" color="#fff" my='10px'>
                    ...
                    <Text
                        fontSize="24px"
                        color="gray" _hover={{ textDecorationLine: "none", color: "white" }}>
                        <Link>
                            <BiCamera />
                        </Link>
                    </Text>
