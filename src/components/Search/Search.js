import { Box, Button, ButtonGroup, Flex, FormControl, Image, Input, Text } from "@chakra-ui/react";
    ...
    return (
        <Box bg='black' >
            <FormControl py='20px' display={['flex']} alignItems="center" px='10px'>
                ...
                />
                <Text fontSize='15px' ms='20px' color='white' position='absolute' left='0px'>
                    <BsSearch />
                </Text>
            </FormControl>
            <Box px='2px'>
                <Flex>
                    <Image src="/image/biryani.jpg"
                        boxSize="115px" />
                    <Image src="/image/icc.webp" p='1x'
                        boxSize="115px" />
                    <Image src="/image/best-times-to-post-on-instagram.jpg"
                        boxSize="115px" />
                </Flex>
                <Flex py='1px'>
                    <Image src="/image/biryani.jpg"
                        boxSize="115px" />
                    <Image src="/image/icc.webp" p='1px'
                        boxSize="115px" />
                    <Image src="/image/best-times-to-post-on-instagram.jpg"
                        boxSize="115px" />
                </Flex>
            ...
            <Box display="flex">
                <Box
                    ...
                    borderRight={["none", "none", "0.3px solid", "0.3px solid", "0.3px solid"]}
                ...
                >
                    ...
                    >
                        {[
                            { btnName: "Home", btnIcon: <Link to='/InstaPage'> <AiFillHome /></Link> },
                            { btnName: "Search", btnIcon: <Link to='/Search'> <BsSearch /></Link> },
                            { btnName: "Reels", btnIcon: <FiPlusSquare /> },
                            { btnName: "Create", btnIcon: <MdOutlineCreateNewFolder />, },
                            { btnName: "Profile", btnIcon: <Link to='/InstaProfile'><CgProfile /></Link> },
                        ].map((item, i) => (
                            <Button
                                justifyContent={[
                                    "space-between",
